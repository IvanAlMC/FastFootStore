...
public class JDialogTime extends JDialog {

	private static final long serialVersionUID = 1L;
	private JTextFieldDialog cc;
	private JButtonsMenuAndDialogs buttonAccept, buttonCancel;

	public JDialogTime(MyJFramePpal frame, ActionListener actionListener) {
		setMinimumSize(new Dimension(350, 180));
		getContentPane().setBackground(new Color(40, 40, 40));
		setBackground(new Color(35, 35, 35));
		setIconImage(new ImageIcon(MyMessage.TIME_PATH).getImage());
		setLocationRelativeTo(frame);
		setTitle(MyMessage.SEE_TIME);
	...
	private void addButtons(ActionListener actionListenner) {
		...
		buttonAccept = new JButtonsMenuAndDialogs(MyMessage.ACCEPT, 120, 35, actionListenner, Actions.ACCEPT_CC_TIME);
		...
		buttonCancel = new JButtonsMenuAndDialogs(MyMessage.CANCEL, 120, 35, actionListenner, Actions.CANCEL_CC_TIME);
